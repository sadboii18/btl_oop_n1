...
public class SachController {
    ...
    public List<Sach> addmasach() {
        List<Sach> listkhoa = new ArrayList<>();
        try {
    ...
    public List<Sach> loadsach() {
        List<Sach> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<Sach> timkiemmasach(String ma) {
        List<Sach> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<Sach> timkiemtensach(String ten) {
        List<Sach> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<Sach> timkiemtentacgia(String ten) {
        List<Sach> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<Sach> timkiemtentheloai(String ten) {
        List<Sach> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<Sach> timkiemtennhaxb(String ten) {
        List<Sach> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
