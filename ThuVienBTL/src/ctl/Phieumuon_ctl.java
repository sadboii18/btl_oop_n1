...
public class Phieumuon_ctl {
  ...
  public static String dbURL ="jdbc:sqlserver://127.0.0.1;databaseName=thuvien;user=sa;password=12345;encrypt=true;trustServerCertificate=true";
    ...
    public List<phieumuon_md> loadphieumuon() {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            ...
            while (rs.next()) {
                phieumuon_md a = new phieumuon_md();
                sv_md b = new sv_md();
                sach_md c = new sach_md();
...
public List<phieumuon_md> loadphieumuonquahan() {
    List<phieumuon_md> listlop = new ArrayList<>();
    try {
        Connection conn = getConnection();
        Statement st = conn.createStatement();
    ...
    public List<phieumuon_md> loadphieumuondangmuonsach() {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<phieumuon_md> loadtongsoluongsachdangmuontheotungmasach() {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
//        ResultSet rs = st.executeQuery("SELECT phieumuon.masach, SUM(phieumuon.soluong) AS total FROM phieumuon inner join sv on sv.masv=phieumuon.masv inner join sach on phieumuon.masach=sach.masach trangthai like N'Chưa Trả' GROUP BY phieumuon.masach");
    ...
    public List<phieumuon_md> loadtongsoluongsachconlaitheomasach() {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<phieumuon_md> timkiemmaphieumuon(String ma) {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<phieumuon_md> timkiemmasv(String ma) {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<phieumuon_md> timkiemmasach(String ma) {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<phieumuon_md> timkiemtensach(String ten) {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
    ...
    public List<phieumuon_md> timkiemtrangthai(String tt) {
        List<phieumuon_md> listlop = new ArrayList<>();
        try {
            Connection conn = getConnection();
            Statement st = conn.createStatement();
...
//        }
//    }
    public static boolean themphieumuon(phieumuon_md phieumuon) {
...
//        }
//    }
public static boolean suaphieumuon(phieumuon_md phieumuon) {
    boolean isSuccess = false;
    Connection connection = null;
    PreparedStatement statement = null;
...
//        }
//    }
public static boolean xoasphieumuon(phieumuon_md phieumuon) {
    boolean isSuccess = false;
    Connection connection = null;
    PreparedStatement statement = null;
