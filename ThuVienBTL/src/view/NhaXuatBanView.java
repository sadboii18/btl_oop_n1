...
public class NhaXuatBanView extends javax.swing.JFrame {
    ...
    private void loadnxb() {
        try {
            nxb_ctl = new NhaXuatBanController();
            List<model.NhaXuatBan> listlop = nxb_ctl.loadnxb();
            ...
            for (model.NhaXuatBan hd : listlop) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(cbtk, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 160, 135, 32));
        getContentPane().add(tk, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 160, 181, 32));
        ...
        getContentPane().add(jToolBar4, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 140, -1, -1));
        ...
        getContentPane().add(mnxb, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 220, 499, -1));
        ...
        getContentPane().add(tnxb, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 250, 499, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText("Số Điện Thoại");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, -1, -1));
        getContentPane().add(sdt, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 280, 499, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Đia Chỉ");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 310, 70, -1));
        getContentPane().add(dc, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, 499, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setText("Ghi Chú");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 340, 58, -1));
        getContentPane().add(gc, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 340, 499, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 380, 860, 129));
...
// Kiểm tra SDT phải là số và tối đa 12 chữ số
        ...
        model.NhaXuatBan hd = new model.NhaXuatBan(manxb, tennxb, diac, sdt1, ghic);
...
// Kiểm tra SDT phải là số và tối đa 12 chữ số
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        try {
            ...
            if (dkien.equals("Tất Cả")) {
                List<model.NhaXuatBan> listkhoa = nxb_ctl.loadnxb();
                DefaultTableModel tb = new DefaultTableModel();
                tb.addColumn("Mã Nhà Xuất Bản");
                tb.addColumn("Tên Nhà Xuất Bản");
                tb.addColumn("Địa Chỉ");
                tb.addColumn("Số Điện Thoại");
                tb.addColumn("ghi Chú");
                for (model.NhaXuatBan a : listkhoa) {
                    tb.addRow(new Object[]{
            ...
            if (dkien.equals("TenNhaXuatBan")) {
                List<model.NhaXuatBan> listkhoa = nxb_ctl.timkiemtennxb(tennxb);
                DefaultTableModel tb = new DefaultTableModel();
                tb.addColumn("Mã Nhà Xuất Bản");
                tb.addColumn("Tên Nhà Xuất Bản");
                tb.addColumn("Địa Chỉ");
            ...
            if (dkien.equals("MaNhaXuatBan")) {
                List<model.NhaXuatBan> listkhoa = nxb_ctl.timkiemmanxb(manxb);
                DefaultTableModel tb = new DefaultTableModel();
                tb.addColumn("Mã Nhà Xuất Bản");
                tb.addColumn("Tên Nhà Xuất Bản");
                tb.addColumn("Địa Chỉ");
            ...
            if (dkien.equals("DiaChi")) {
                List<model.NhaXuatBan> listkhoa = nxb_ctl.timkiemdiachi(diachi);
                DefaultTableModel tb = new DefaultTableModel();
                tb.addColumn("Mã Nhà Xuất Bản");
                tb.addColumn("Tên Nhà Xuất Bản");
                tb.addColumn("Địa Chỉ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhaXuatBanView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhaXuatBanView().setVisible(true);
            }
        });
    }
