...
public class TheLoaiView extends javax.swing.JFrame {
    ...
    private void loadtheloai() {
        try {
            List<model.TheLoai> listkhoa = theloai_ctl.loadtheloai();
            DefaultTableModel tb = new DefaultTableModel();
            tb.addColumn("Mã Thể Loại");
            tb.addColumn("Tên Thể Loại");
            tb.addColumn("Ghi Chú");

            for (model.TheLoai a : listkhoa) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 360, 920, 150));

        cbtk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tất Cả", "MaTheLoai", "TenTheLoai" }));
        getContentPane().add(cbtk, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, 112, 32));
        getContentPane().add(tk, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 150, 116, 32));
        ...
        getContentPane().add(jToolBar4, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 130, -1, -1));
        ...
        getContentPane().add(mtl, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 220, 486, -1));
        ...
        getContentPane().add(ttl, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, 486, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Ghi Chú");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 300, -1, -1));
        getContentPane().add(gc, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 300, 486, -1));
...
// Kiểm tra tên thể loại không được để trống
        ...
        model.TheLoai a = new model.TheLoai(matl, tentl, ghichu);
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        try {
            ...
            if (dkien.equals("TenTheLoai")) {
                List<model.TheLoai> listkhoa = theloai_ctl.timkiemtentheloai(tentheloai);
                DefaultTableModel tb = new DefaultTableModel();
                tb.addColumn("Mã Thể Loại");
                tb.addColumn("Tên Thể Loại");
                tb.addColumn("Ghi Chú");
            ...
            if (dkien.equals("MaTheLoai")) {
                List<model.TheLoai> listkhoa = theloai_ctl.timkiemmatheloai(matheloai);
                DefaultTableModel tb = new DefaultTableModel();
                tb.addColumn("Mã Thể Loại");
                tb.addColumn("Tên Thể Loại");
                tb.addColumn("Ghi Chú");
