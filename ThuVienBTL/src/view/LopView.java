...
public class LopView extends javax.swing.JFrame {
    ...
    private LopController lop_ctl;

    public LopView() {
        initComponents();
        lop_ctl = new LopController();
    ...
    private void addmk() {
        try {
            List<Khoa> listkhoa = khoa_ctl.addmakhoa();
    ...
    private void loadlop() {
        try {
            lop_ctl = new LopController();
            List<model.Lop> listlop = lop_ctl.loadlop();
            DefaultTableModel tb = new DefaultTableModel();
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        ...
        model.Lop hd = new model.Lop(malop, tenlp, ghichu, makhoa);
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        ...
        try {
            ...
            if (dkien.equals("Tất Cả")) {
                List<model.Lop> listhd = lop_ctl.loadlop();
                DefaultTableModel tb = new DefaultTableModel();
            ...
            if (dkien.equals("MaLop")) {
                List<model.Lop> listhd = lop_ctl.timkiemmalop(malop);
                DefaultTableModel tb = new DefaultTableModel();
            ...
            if (dkien.equals("TenLop")) {
                List<model.Lop> listhd = lop_ctl.timkiemtenlop(tenlop);
                DefaultTableModel tb = new DefaultTableModel();
            ...
            if (dkien.equals("TenKhoa")) {
                ...
                List<model.Lop> listhd = lop_ctl.timkiemtenkhoa(tenkhoa);
                DefaultTableModel tb = new DefaultTableModel();
            ...
            if (dkien.equals("MaKhoa")) {
                ...
                List<model.Lop> listhd = lop_ctl.timkiemmakhoa(makhoa);
                DefaultTableModel tb = new DefaultTableModel();
