...
public class Ravao extends javax.swing.JFrame {

    private Ravao_ctl ravao_ctl;

    public Ravao() {
        initComponents();
        ravao_ctl = new Ravao_ctl();
        loadravao();
    ...
    private void loadravao() {
        try {
            List<ravao_md> listkhoa = ravao_ctl.loadravao();
...
//                    hd.getMalop(),
    ...
    private void initComponents() {
        ...
        getContentPane().add(cbtk, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 280, 119, 32));
        getContentPane().add(tk, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 280, 190, 32));
        ...
        getContentPane().add(jToolBar4, new org.netbeans.lib.awtextra.AbsoluteConstraints(969, 270, 460, 50));
        getContentPane().add(m, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 330, 360, -1));

        n.setDateFormatString("yyyy-MM-dd");
        getContentPane().add(n, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 370, 360, -1));

        v.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "7h", "8h", "9h", "10h", "11h", "14h", "15h", "16h", "17h" }));
        getContentPane().add(v, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 400, 360, -1));

        r.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "8h", "9h", "10h", "11h", "15h", "16h", "17h" }));
        getContentPane().add(r, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 440, 360, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("T/g Ra");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 440, -1, -1));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 360, -1, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Nội Dung");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 400, -1, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("Ghi Chú");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 440, -1, -1));
        getContentPane().add(gc, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 440, 350, -1));
        ...
        getContentPane().add(nd, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 400, 350, -1));
        getContentPane().add(msv, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 360, 350, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 482, 1370, 190));
...
//                tb.addColumn("Mã Lớp");
            ...
            if (dkien.equals("Ngay")) {
                List<ravao_md> listkhoa = ravao_ctl.timkiemngay(ngay);
                DefaultTableModel tb = new DefaultTableModel();
...
//                tb.addColumn("Mã Lớp");
            ...
            if (dkien.equals("Ma")) {
                List<ravao_md> listkhoa = ravao_ctl.timkiemma(ma);
                DefaultTableModel tb = new DefaultTableModel();
...
//                tb.addColumn("Mã Lớp");
            ...
            if (dkien.equals("MaSv")) {
                List<ravao_md> listkhoa = ravao_ctl.timkiemmasv(masv);
                 DefaultTableModel tb = new DefaultTableModel();
...
//                tb.addColumn("Mã Lớp");
            ...
            if (dkien.equals("MaLop")) {
                List<ravao_md> listkhoa = ravao_ctl.timkiemmalop(malop);
                 DefaultTableModel tb = new DefaultTableModel();
...
if (!ravao_ctl.checkmasv(masv)) {
    ...
    return;
        ...
        ravao_md hd = new ravao_md(mas, ngay, vao, ra, masv, noid, ghic);
        if (ravao_ctl.sua(hd)) {
            loadravao();
...
//        String mal = ml.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ravao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
