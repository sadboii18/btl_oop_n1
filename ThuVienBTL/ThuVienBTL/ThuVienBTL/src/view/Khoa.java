...
public class Khoa extends javax.swing.JFrame {
    ...
    private void loadkhoa() {
        try {
            List<khoa_md> listkhoa = khoa_ctl.loadkhoa();
    ...
    private void initComponents() {
        ...
        getContentPane().add(cbtk, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 220, 160, 32));
        getContentPane().add(tk, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 220, 200, 32));
        ...
        getContentPane().add(jToolBar4, new org.netbeans.lib.awtextra.AbsoluteConstraints(699, 210, -1, 50));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Mã Khoa");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 280, -1, -1));
        ...
        getContentPane().add(gc, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 350, 317, -1));
        getContentPane().add(tenk, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 310, 317, -1));
        getContentPane().add(mk, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 280, 317, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 390, 945, 200));
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        ...
        khoa_md a = new khoa_md(makhoa, tenkhoa, ghichu);
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        try {
            ...
            if (dkien.equals("TenKhoa")) {
                List<khoa_md> listkhoa = khoa_ctl.timkiemtenkhoa(tenkhoa);
                DefaultTableModel tb = new DefaultTableModel();
                tb.addColumn("Mã khoa");
                tb.addColumn("Tên khoa");
                tb.addColumn("Ghi Chú");
            ...
            if (dkien.equals("MaKhoa")) {
                List<khoa_md> listkhoa = khoa_ctl.timkiemmakhoa(makhoa);
                DefaultTableModel tb = new DefaultTableModel();
                tb.addColumn("Mã khoa");
                tb.addColumn("Tên khoa");
                tb.addColumn("Ghi Chú");
